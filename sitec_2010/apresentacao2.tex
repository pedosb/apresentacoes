...
{Desenvolvimento de Aplicativos com Reconhecimento de Voz e SpeechOO: extensão de ditado para o OpenOffice}
...
\date[22 de outubro de 2010] % (optional)
{Semana do Instituto de Tecnologia - 2010}
...
\begin{document}
   ...
   \frame{
	...
	\frame{
		\frametitle{O Decodificador Julius}
		\begin{itemize}
			\item Decodificador Automático de Voz Continua Open-Source para Grandes Vocabulários.
...
\end{verbatim}
   ...
   \begin{frame}
	...
	\frame{
		\frametitle{Sintetizador de Voz Livre para Português
		     Brasileiro}
		\begin{itemize}
			\item Criação de um sintetizador completo para o Português Brasileiro.
			\item Possível integração com o orca.
		\end{itemize}
	}
